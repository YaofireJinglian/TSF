...
if __name__ == '__main__':# main
    ...
    # RANDOM SEED
    parser.add_argument('--random_seed', type=int, default=2024, help='random seed') # 2024,42,3407
    ...
    # DATALOADER
    parser.add_argument('--data', type=str, required=False, default='PEMS', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data/PEMS', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='PEMS08.npz', help='data file')
    ...
    parser.add_argument('--n2',type=int,default=32,help='Second Embedded representation')
    ...
    parser.add_argument('--enc_in', type=int, default=170, help='encoder input size') #Use this hyperparameter as the number of channels
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_n1{}_n2{}_dr{}_cin{}_res{}_dst{}_dconv{}_efact{}'.format(
                args.model_id,
                args.model,
                args.model_id_name,
                args.features,
